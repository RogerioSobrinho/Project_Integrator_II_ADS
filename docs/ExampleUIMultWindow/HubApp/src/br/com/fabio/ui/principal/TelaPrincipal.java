...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    TelaConsultarClientes tccadc = null;
    TelaCadastrarQuarto tcadq = null;
    TelaConsultarQuartos tconq = null;
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        if (tccadc == null || !tccadc.isDisplayable()) {
            tccadc = new TelaConsultarClientes();
            tccadc.pack();
            tccadc.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            tccadc.setLocationRelativeTo(null);
            tccadc.setVisible(true);
        }
        tccadc.toFront();
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        if (tcadq == null || !tcadq.isDisplayable()) {
            tcadq = new TelaCadastrarQuarto();
            tcadq.pack();
            tcadq.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            tcadq.setLocationRelativeTo(null);
            tcadq.setVisible(true);
        }
        tcadq.toFront();
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        if (tconq == null || !tconq.isDisplayable()) {
            tconq = new TelaConsultarQuartos();
            tconq.pack();
            tconq.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            tconq.setLocationRelativeTo(null);
            tconq.setVisible(true);
        }
        tconq.toFront();
